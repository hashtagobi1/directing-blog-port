...
export default function Navbar(props) {
  ...
  return (
    <Container>
      <div className="flex flex-col px-5 py-3 font-bold cursor-pointer">
        <Link href="/" passHref>
          <h1 className="uppercase">Obi anokwuru</h1>
          <h2 className="italic">Creative Director (Writer & Director)</h2>
        </Link>
      </div>
      <nav>
        <Disclosure>
